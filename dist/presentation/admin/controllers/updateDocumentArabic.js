...
const updateDocumentArabicController = (dependencies) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("my loged document current fullname ", documentToUpdate.fullNameAr);
            console.log("my loged document current nICK name ", documentToUpdate.nickNameAr);
            ...
            try {
                var last = yield ArabicDocumentSchema_1.ArabicDocument.findOneAndUpdate({ _id: id }, documentToUpdate, {
                    new: true,
                    upsert: true,
