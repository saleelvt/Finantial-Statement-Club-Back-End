...
const FileSchema = new mongoose_1.Schema({
    ...
    table: {
        BalanceSheet: {
            ...
            data1En: { type: mongoose_1.Schema.Types.Mixed },
            data2En: { type: mongoose_1.Schema.Types.Mixed },
            // Equity section
            equity: {
        ...
        CashFlow: {
            // Additional data fields
            date1Ar: { type: mongoose_1.Schema.Types.Mixed },
            date2Ar: { type: mongoose_1.Schema.Types.Mixed },
            sectionOne: {
            ...
            Table2: {
                dateTwo1Ar: { type: mongoose_1.Schema.Types.Mixed },
                dateTwo2Ar: { type: mongoose_1.Schema.Types.Mixed },
                sectionOneTable2: {
