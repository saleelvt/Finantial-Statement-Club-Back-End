...
const adminRoutes = (dependencies) => {
    ...
    router.route("/addDocumentArabic").post(multer_1.default.fields([
        { name: "Board" },
        { name: "Q1" },
        { name: "Q2" },
        { name: "Q3" },
    ...
    router.route("/addTable").post(multer_1.default.fields([{ name: "screenshotFile" }]), addTable);
