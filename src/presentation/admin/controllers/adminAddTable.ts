      ...
      if (category === "BalanceSheet" && data) {
        ...
        const balanceSheetData = {
          ...
          assets: {
            ...
            nonCurrent: {
              snonCurrentAssets: data.assets?.nonCurrent?.snonCurrentAssets || "",
        ...
        console.log("Assets Total Date2:", balanceSheetData.assets.totalAssetsDate2);
        console.log("Equity Total:", balanceSheetData.equity.totalEquity);
        console.log("Equity Total Date2:", balanceSheetData.equity.totalEquityDate2);
        console.log("Liabilities Total:", balanceSheetData.liabilities.totalLiabilities);
        console.log("Liabilities Total Date2:", balanceSheetData.liabilities.totalLiabilitiesDate2);
        console.log("Total Equity & Liabilities:", balanceSheetData.ItotalEquityAndLiabilities);
        console.log("Total Equity & Liabilities Date2:", balanceSheetData.ItotalEquityAndLiabilitiesDate2);
        ...
        try {
          ...
          const savedBalanceSheet = verifiedDoc?.formData[section]?.table?.BalanceSheet;
          console.log("Verification - Total values after save:");
          console.log("Assets Total:", savedBalanceSheet?.assets?.totalAssets);
          console.log("Equity Total:", savedBalanceSheet?.equity?.totalEquity);
          console.log("Liabilities Total:", savedBalanceSheet?.liabilities?.totalLiabilities);
